...
async def test_async_get_tasks(async_empty_index, small_movies):
    index = await async_empty_index()
...
async def test_async_get_tasks_for_index(async_empty_index, small_movies):
    index = await async_empty_index()
...
async def test_async_get_task(async_empty_index, small_movies):
    index = await async_empty_index()
    response = await index.add_documents(small_movies)
    await async_wait_for_task(index.http_client, response.task_uid)
...
async def test_async_wait_for_task(async_empty_index, small_movies):
    index = await async_empty_index()
    response = await index.add_documents(small_movies)
...
async def test_async_wait_for_task_no_timeout(async_empty_index, small_movies):
    index = await async_empty_index()
    response = await index.add_documents(small_movies)
...
async def test_wait_for_pending_update_time_out(async_empty_index, small_movies):
    index = await async_empty_index()
...
async def test_async_wait_for_task_raise_for_status_true(async_empty_index, small_movies):
    index = await async_empty_index()
    response = await index.add_documents(small_movies)
...
async def test_async_wait_for_task_raise_for_status_true_no_timeout(
    async_empty_index, small_movies, base_url, monkeypatch
):
