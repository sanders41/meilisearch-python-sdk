...
async def async_wait_for_task(
    ...
    *,
    ...
    Examples:
        ...
        >>>     async_wait_for_task(client, response.update_id)
    """
    client_ = _get_async_client(client)
    url = f"tasks/{task_id}"
...
def get_task(client: HttpxClient | Client, task_id: int) -> TaskResult:
    ...
    Args:
        ...
        client: An httpx Client or meilisearch_python_async Client instance.
        task_id: Identifier of the task to retrieve.
...
def wait_for_task(
    ...
    *,
    ...
    Examples:
        ...
        >>> index = client.index("movies")
        >>> response = await index.add_documents(documents)
        >>> wait_for_pending_task(client, response.update_id)
    """
    client_ = _get_client(client)
    url = f"tasks/{task_id}"
